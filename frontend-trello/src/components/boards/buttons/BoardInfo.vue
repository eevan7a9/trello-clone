  ...
  <div class="dropdown">
    ...
    <div class="dropdown-content mt-3 mr-2 pb-3" :class="{'active': popupsValue === dropdownOf}">
      <header class="py-2 px-1 m-0 row">
        <span class="col-md-10 text-capitalize text-muted m-0 pl-5">Information</span>
      ...
      <div class="px-4 text-dark w-100">
        ...
        >It’s Easy To Get Your Team Up And Running With Trello Playbooks</h6>
        <hr />
